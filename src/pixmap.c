...
/*                Version:        1.3.0					      */
/*                Date:           12/8/2002				      */
/*		  Routines associated with pixmaps	                      */
/*									      */
/*============================================================================*/
...
/******************************************************************************/
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
/* This is an internally used function to create dummy pixmaps when a certain */
/* cannot be found							      */
/*									      */
...
create_pixmap (GtkWidget * widget, const gchar * filename)
{
  ...
  while (elem)			/* find the pixmap file     */
    {
  ...
  if (!found_filename)		/* unable to get file */
    {
